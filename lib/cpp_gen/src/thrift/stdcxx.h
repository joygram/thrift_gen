...
//#define FORCE_BOOST_FUNCTIONAL 1 // use only boost by joygram
#define FORCE_BOOST_SMART_PTR  1 // use only boost by joygram
///////////////////////////////////////////////////////////////////
//
...
#include <boost/functional.hpp> // support for boost 166 by joygram 2018/03/30
