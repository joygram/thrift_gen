 ...
 * details.
 generate each class files to namespace file by joygram
 */
...
std::ofstream f_file_; // single file stream by joygram
...
class t_gen_csharp_generator : public t_oop_generator {
public:
  t_gen_csharp_generator(t_program* program,
  ...
  void generate_csharp_struct_deepclone(std::ostream& out,
                                        t_struct* tstruct); // c# deepclone by joygram 2018/01/15

  void generate_csharp_struct_dumpstring(std::ostream& out,
                                         t_struct* tstruct); // c# dumpstring by joygram 2022/08/11

    void generate_csharp_struct_tojson(std::ostream& out,
                                         t_struct* tstruct); // c# tojson by joygram 2022/09/05
  ...
  /////////////////////////////////////////////////
  // c# deepclone by joygram 2018/01/15
  void generate_deepclone_field(std::ostream& out,
                                t_type* tcontainer,
                                t_field* tfield,
                                ...
                                bool is_element = false,
                                bool is_propertyless = false);
  void generate_deepclone_struct(std::ostream& out,
                                 t_struct* tstruct,
                                 std::string tgt_name = "",
                                 std::string src_name = "");
  void generate_deepclone_container(std::ostream& out,
                                    t_type* ttype,
                                    bool is_element,
                                    std::string prefix = "");
  void generate_deepclone_map(std::ostream& out,
                              t_type* ttype,
                              bool is_element,
                              std::string prefix = "");
  void generate_deepclone_set(std::ostream& out,
                              t_type* ttype,
                              bool is_element,
                              std::string prefix = "");
  void generate_deepclone_list(std::ostream& out,
                               t_type* ttype,
                               bool is_element,
                               std::string prefix = "");
  void generate_deepclone_map_element(std::ostream& out,
                                      t_map* tmap,
                                      bool is_container_element,
                                      std::string iter,
                                      std::string map);
  void generate_deepclone_set_element(std::ostream& out,
                                      t_set* tmap,
                                      bool is_container_element,
                                      std::string iter,
                                      std::string set_name);
  void generate_deepclone_list_element(std::ostream& out,
                                       t_list* tlist,
                                       bool is_container_element,
                                       std::string iter,
  ...
  /////////////////////////////////////////////////
  // c# dump container by joygram 2022/08/11
  void generate_dumpstring_field(std::ostream& out,
                                 t_type* tcontainer,
                                 t_field* tfield,
                                 std::string iter_name = "",
                                 std::string elem_name = "",
                                 bool is_element = false,
                                 bool is_propertyless = false);
  void generate_dumpstring_struct(std::ostream& out,
                                  t_struct* tstruct,
                                  std::string tgt_name = "",
                                  std::string src_name = "");
  void generate_dumpstring_container(std::ostream& out,
                                     t_type* ttype,
                                     bool is_element,
                                     std::string prefix = "");
  void generate_dumpstring_map(std::ostream& out,
                               t_type* ttype,
                               bool is_element,
                               std::string prefix = "");
  void generate_dumpstring_set(std::ostream& out,
                               t_type* ttype,
                               bool is_element,
                               std::string prefix = "");
  void generate_dumpstring_list(std::ostream& out,
                                t_type* ttype,
                                bool is_element,
                                std::string prefix = "");
  void generate_dumpstring_map_element(std::ostream& out,
                                       t_map* tmap,
                                       bool is_container_element,
                                       std::string iter,
                                       std::string map);
  void generate_dumpstring_set_element(std::ostream& out,
                                       t_set* tmap,
                                       bool is_container_element,
                                       std::string iter,
                                       std::string set_name);
  void generate_dumpstring_list_element(std::ostream& out,
                                        t_list* tlist,
                                        bool is_container_element,
                                        std::string iter,
                                        std::string list_name);
  ...
  /////////////////////////////////////////////////
  // c# tojson by joygram 2022/09/05
  void generate_tojson_field(std::ostream& out,
                                 t_type* tcontainer,
                                 t_field* tfield,
                                 std::string iter_name = "",
                                 std::string elem_name = "",
                                 bool is_element = false,
                                 bool is_propertyless = false);
  void generate_tojson_struct(std::ostream& out,
                                  t_struct* tstruct,
                                  std::string tgt_name = "",
                                  std::string src_name = "");
  void generate_tojson_container(std::ostream& out,
                                     t_type* ttype,
                                     bool is_element,
                                     std::string prefix = "");
  void generate_tojson_map(std::ostream& out,
                               t_type* ttype,
                               bool is_element,
                               std::string prefix = "");
  void generate_tojson_set(std::ostream& out,
                               t_type* ttype,
                               bool is_element,
                               std::string prefix = "");
  void generate_tojson_list(std::ostream& out,
                                t_type* ttype,
                                bool is_element,
                                std::string prefix = "");
  void generate_tojson_map_element(std::ostream& out,
                                       t_map* tmap,
                                       bool is_container_element,
                                       std::string iter,
                                       std::string map);
  void generate_tojson_set_element(std::ostream& out,
                                       t_set* tmap,
                                       bool is_container_element,
                                       std::string iter,
                                       std::string set_name);
  void generate_tojson_list_element(std::ostream& out,
                                        t_list* tlist,
                                        bool is_container_element,
                                        std::string iter,
                                        std::string list_name);
  ...
  std::string prop_name(t_field* tfield,
                        bool suppress_mapping = true); // default to true by joygram
...
void t_gen_csharp_generator::init_generator() {
  MKDIR(get_out_dir().c_str());
  namespace_name_ = program_->get_namespace("csharp");

  /* generate file with namespace only by joygram
  ...
  */
  ...
  // make single file by joygram
  string f_file_name = get_out_dir() + program_->get_name() + ".cs";
  f_file_.open(f_file_name.c_str(), std::ofstream::out | std::ofstream::trunc);
  f_file_ << autogen_comment() << csharp_type_usings() << csharp_thrift_usings() << endl;

  pverbose("=== prog info: name:%s out_file_path:%s \n", program_->get_name().c_str(),
           f_file_name.c_str());

  start_csharp_namespace(f_file_);
}

std::string t_gen_csharp_generator::normalize_name(std::string name) {
  string tmp(name);
...
void t_gen_csharp_generator::init_keywords() {
...
void t_gen_csharp_generator::start_csharp_namespace(ostream& out) {
...
void t_gen_csharp_generator::end_csharp_namespace(ostream& out) {
  if (!namespace_name_.empty()) {
    scope_down(out);
  }
}

string t_gen_csharp_generator::csharp_type_usings() {
...
string t_gen_csharp_generator::csharp_thrift_usings() {
  return string() + "using Thrift.Protocol;\n" + "using Thrift.Transport;\n";
}

void t_gen_csharp_generator::close_generator() {
  end_csharp_namespace(f_file_);
  f_file_.close();
}
void t_gen_csharp_generator::generate_typedef(t_typedef* ttypedef) {
  (void)ttypedef;
}

void t_gen_csharp_generator::generate_enum(t_enum* tenum) {
  /*
    string f_enum_name = namespace_dir_ + "/" + (tenum->get_name()) + ".cs";
    ofstream_with_content_based_conditional_update f_enum;
    f_enum.open(f_enum_name.c_str());
  */
  ostream& f_enum = f_file_; // enum into namespace file by joygram
  f_enum << autogen_comment() << endl;

  //  start_csharp_namespace(f_enum); // enum into namespace file by joygram
  ...
  //  end_csharp_namespace(f_enum); // enum into namespace file by joygram

  //  f_enum.close(); // enum into namespace file by joygram
}

void t_gen_csharp_generator::generate_consts(std::vector<t_const*> consts) {
  if (consts.empty()) {
    return;
  }
  /* const into namespace file by jogyram
  ...
  */
  ostream& f_consts = f_file_; //  const into namespace file [2015/7/6/ joygram]
  ...
  for (c_iter = consts.begin(); c_iter != consts.end(); ++c_iter) {
    ...
    if (print_const_value(f_consts, (*c_iter)->get_name(), (*c_iter)->get_type(),
...
void t_gen_csharp_generator::print_const_def_value(std::ostream& out,
                                                   string name,
                                                   t_type* type,
                                                   t_const_value* value) {
...
void t_gen_csharp_generator::print_const_constructor(std::ostream& out,
...
// would imply
bool t_gen_csharp_generator::print_const_value(std::ostream& out,
                                               string name,
                                               t_type* type,
                                               t_const_value* value,
                                               bool in_static,
  ...
  if (!defval || needtype) {
    out << (in_static              ? ""
            : type->is_base_type() ? "public const "
                                   : "public static ")
        << type_name(type) << " ";
  }
...
std::string t_gen_csharp_generator::render_const_value(ostream& out,
                                                       string name,
                                                       t_type* type,
                                                       t_const_value* value) {
  (void)name;
...
void t_gen_csharp_generator::generate_struct(t_struct* tstruct) {
...
void t_gen_csharp_generator::generate_xception(t_struct* txception) {
  generate_csharp_struct(txception, true);
}

void t_gen_csharp_generator::generate_csharp_struct(t_struct* tstruct, bool is_exception) {
  /* struct into namespace file by jogyram
    ...
    f_struct.close();
  */
  ostream& f_struct = f_file_; // struct into namespace file by [2015/7/6/ joygram]
  generate_csharp_struct_definition(f_struct, tstruct, is_exception);
}

void t_gen_csharp_generator::generate_csharp_struct_definition(ostream& out,
                                                               t_struct* tstruct,
                                                               bool is_exception,
                                                               bool in_class,
                                                               bool is_result) {
  /* struct into namespace file by joygyram
    if (!in_class) {
  ...
  */
  ...
  if (generate_isset) {
    out << endl;
    if (serialize_ || wcf_) {
      out << indent() << "[XmlIgnore] // XmlSerializer" << endl
          << indent()
  ...
  for (m_iter = members.begin(); m_iter != members.end(); ++m_iter) {
    ...
    if ((*m_iter)->get_value() != NULL) {
      if (field_is_required((*m_iter))) {
        ...
        print_const_value(out, "this._" + (*m_iter)->get_name(), t, (*m_iter)->get_value(), true,
                          true);
    ...
    for (m_iter = members.begin(); m_iter != members.end(); ++m_iter) {
      if (field_is_required((*m_iter))) {
        indent(out) << "this." << prop_name((*m_iter)) << " = "
                    << normalize_name((*m_iter)->get_name()) << ";" << endl;
      }
    }
  ...
  // generate deepclone
  generate_csharp_struct_deepclone(out, tstruct);

  // generate dumpstring
  generate_csharp_struct_dumpstring(out, tstruct);

  // generate tojson
  generate_csharp_struct_tojson(out, tstruct);
  ...
  /* struct into namespace file by joygram
    if (!in_class) {
...
void t_gen_csharp_generator::generate_csharp_wcffault(ostream& out, t_struct* tstruct) {
  out << endl;
  indent(out) << "#if !SILVERLIGHT" << endl;
  indent(out) << "[Serializable]" << endl;
  indent(out) << "#endif" << endl;
...
void t_gen_csharp_generator::generate_csharp_struct_reader(ostream& out, t_struct* tstruct) {
  ...
  for (f_iter = fields.begin(); f_iter != fields.end(); ++f_iter) {
    if (field_is_required((*f_iter))) {
      ...
      out << indent() << "throw new TProtocolException(TProtocolException.INVALID_DATA, "
          << "\"required field " << prop_name((*f_iter)) << " not set\");" << endl;
      indent_down();
    }
  }
...
void t_gen_csharp_generator::generate_csharp_struct_writer(ostream& out, t_struct* tstruct) {
...
void t_gen_csharp_generator::generate_csharp_struct_result_writer(ostream& out, t_struct* tstruct) {
...
void t_gen_csharp_generator::generate_csharp_struct_tostring(ostream& out, t_struct* tstruct) {
  ...
  for (f_iter = fields.begin(); f_iter != fields.end(); ++f_iter) {
    ...
    } else if (ttype->is_list()) { //리스트인 경우 스트링 덤프 추가 by joygram 2022/08/11
...
void t_gen_csharp_generator::generate_csharp_union(t_struct* tunion) {
  /* to single file by joygram
  ...
  */
  ostream& f_union = f_file_; // to single file by [2015/7/6/ joygram]
  generate_csharp_union_definition(f_union, tunion);

  //  f_union.close();
}

void t_gen_csharp_generator::generate_csharp_union_definition(std::ostream& out, t_struct* tunion) {
  // Let's define the class first
  //  start_csharp_namespace(out); // to single file by joygram
  ...
  indent(out) << "throw new TProtocolException( TProtocolException.INVALID_DATA, \"Cannot persist "
                 "an union type which is not set.\");"
              << endl;
  indent_down();
  indent(out) << "}" << endl << endl;
  ...
  //  end_csharp_namespace(out); // to single file by joygram
}

void t_gen_csharp_generator::generate_csharp_union_class(std::ostream& out,
                                                         t_struct* tunion,
                                                         t_field* tfield) {
...
void t_gen_csharp_generator::generate_csharp_struct_equals(ostream& out, t_struct* tstruct) {
...
void t_gen_csharp_generator::generate_csharp_struct_hashcode(ostream& out, t_struct* tstruct) {
...
// c# deepclone method by joygram 2018/01/15
void t_gen_csharp_generator::generate_csharp_struct_deepclone(ostream& out, t_struct* tstruct) {

  string name = tstruct->get_name();
  const vector<t_field*>& fields = tstruct->get_sorted_members();
  vector<t_field*>::const_iterator f_iter;

  string true_type = type_name(tstruct->get_true_type(), false, true);

  out << indent() << "public TBase DeepClone() { //generate_csharp_struct_deepclone" << endl;
  indent_up();

  indent(out) << true_type << " target = new " << true_type << "();" << endl;
  ...
  if (fields.size() > 0) {
    for (f_iter = fields.begin(); f_iter != fields.end(); ++f_iter) {
      ...
      generate_deepclone_field(out, tstruct, *f_iter);
...
////////////////////////////////////////////
// c# dumpstring method by joygram 2022/08/11
void t_gen_csharp_generator::generate_csharp_struct_dumpstring(ostream& out, t_struct* tstruct) {
  ...
  out << indent() << "public string DumpString() { //" << true_type << endl;
  indent_up();
  indent(out) << "StringBuilder __sb = new StringBuilder(\"" << true_type << "(\\n\");" << endl;
    ...
    for (f_iter = fields.begin(); f_iter != fields.end(); ++f_iter) {
      ...
      if (is_required) {
        if (null_allowed) {
          ...
          indent_up();
          out << indent() << "throw new TProtocolException(TProtocolException.INVALID_DATA, "
              << "\"DumpString() required field " << prop_name((*f_iter)) << " not set\");" << endl;
          indent_down();
        }
      } else {
        if (nullable_ && !has_default) {
      ...
      generate_dumpstring_field(out, tstruct, *f_iter);
...
////////////////////////////////////////////
// c# tojson method by joygram 2022/09/05
void t_gen_csharp_generator::generate_csharp_struct_tojson(ostream& out, t_struct* tstruct) {
  ...
  out << indent() << "public string ToJson() { //" << true_type << endl;
  indent_up();
  //indent(out) << std::format("string __sb = \"{{\";") << endl;
  indent(out) << std::format("string __sb = \"\";") << endl;
  indent(out) << std::format("__sb += \" \\\"{}\\\": {{\"; ", true_type) << endl;

  const int32_t max_field_idx = (int32_t)fields.size() -1;
  int32_t field_idx = 0; //for comma 
  if (fields.size() > 0) {
    for (f_iter = fields.begin(); f_iter != fields.end(); ++f_iter) {
      bool is_required = field_is_required((*f_iter));
      bool has_default = field_has_default((*f_iter));
      ...
      if (is_required) {
        if (null_allowed) {
          ...
          indent_up();
          out << indent() << "throw new TProtocolException(TProtocolException.INVALID_DATA, "
              << "\"ToJson() required field " << prop_name((*f_iter)) << " not set\");" << endl;
          indent_down();
        }
      } else {
        if (nullable_ && !has_default) {
      ...
      generate_tojson_field(out, tstruct, *f_iter);

      field_idx++;
      //if (max_field_idx > field_idx) { //add comma except last
        indent(out) << "__sb += \", \";" << endl;
      //}
    ...
    indent(out) << "__sb += \"}\";" << endl; // close struct 
    indent(out) << "return __sb;" << endl;
  } // field size > 0
  indent_down();
  indent(out) << "}" << endl << endl;
}
...
void t_gen_csharp_generator::generate_service(t_service* tservice) {
  /* to single file by joygram
  ...
  */
  ostream& f_service_ = f_file_; // to single file [2015/7/6/ joygram]
...
void t_gen_csharp_generator::generate_service_interface(t_service* tservice) {
  generate_separate_service_interfaces(tservice);
}

void t_gen_csharp_generator::generate_separate_service_interfaces(t_service* tservice) {
...
void t_gen_csharp_generator::generate_sync_service_interface(t_service* tservice) {
  string extends = "";
  ...
  if (wcf_) {
    indent(f_service_) << "[System.ServiceModel.ServiceContract(Namespace=\"" << wcf_namespace_
                       << "\")]" << endl;
  }
...
void t_gen_csharp_generator::generate_async_service_interface(t_service* tservice) {
  string extends = "";
  string extends_iface = "";
  if (tservice->get_extends() != NULL) {
    extends = type_name(tservice->get_extends());
...
void t_gen_csharp_generator::generate_combined_service_interface(t_service* tservice) {
...
void t_gen_csharp_generator::generate_silverlight_async_methods(t_service* tservice) {
  vector<t_function*> functions = tservice->get_functions();
  vector<t_function*>::iterator f_iter;
  for (f_iter = functions.begin(); f_iter != functions.end(); ++f_iter) {
    generate_csharp_doc(f_service_, *f_iter);
...
void t_gen_csharp_generator::generate_service_helpers(t_service* tservice) {
  vector<t_function*> functions = tservice->get_functions();
  vector<t_function*>::iterator f_iter;
...
void t_gen_csharp_generator::generate_service_client(t_service* tservice) {
  string extends = "";
  ...
  for (f_iter = functions.begin(); f_iter != functions.end(); ++f_iter) {
    ...
    if (!(*f_iter)->is_oneway()) {
      ...
      f_service_ << indent() << "TMessage msg = iprot_.ReadMessageBegin();" << endl
      ...
      if (!(*f_iter)->get_returntype()->is_void()) {
        if (nullable_) {
          if (type_can_be_null((*f_iter)->get_returntype())) {
            f_service_ << indent() << "if (result.Success != null) {" << endl
                       << indent() << "  return result.Success;" << endl
                       << indent() << "}" << endl;
          } else {
            f_service_ << indent() << "if (result.Success.HasValue) {" << endl
...
void t_gen_csharp_generator::generate_service_server(t_service* tservice) {
  if (async_) {
...
void t_gen_csharp_generator::generate_service_server_sync(t_service* tservice) {
  vector<t_function*> functions = tservice->get_functions();
  vector<t_function*>::iterator f_iter;
  ...
  if (extends.empty()) {
    f_service_ << indent()
               << "protected Dictionary<string, ProcessFunction> processMap_ = new "
                  "Dictionary<string, ProcessFunction>();"
               << endl;
  }
...
void t_gen_csharp_generator::generate_service_server_async(t_service* tservice) {
  vector<t_function*> functions = tservice->get_functions();
  vector<t_function*>::iterator f_iter;
  ...
  indent(f_service_) << "public class AsyncProcessor : " << extends_processor << "TAsyncProcessor {"
                     << endl;
  indent_up();
  ...
  if (extends.empty()) {
    indent(f_service_) << "public async Task<bool> ProcessAsync(TProtocol iprot, TProtocol oprot)"
                       << endl;
  } else {
    indent(f_service_)
        << "public new async Task<bool> ProcessAsync(TProtocol iprot, TProtocol oprot)" << endl;
  }
  scope_up(f_service_);
...
void t_gen_csharp_generator::generate_function_helpers(t_function* tfunction) {
...
void t_gen_csharp_generator::generate_process_function(t_service* tservice, t_function* tfunction) {
  (void)tservice;
  ...
  f_service_ << indent() << "try" << endl << indent() << "{" << endl;
  indent_up();
...
void t_gen_csharp_generator::generate_process_function_async(t_service* tservice,
...
void t_gen_csharp_generator::generate_csharp_union_reader(std::ostream& out, t_struct* tunion) {
...
void t_gen_csharp_generator::generate_deserialize_field(ostream& out,
                                                        t_field* tfield,
                                                        string prefix,
  ...
  string name = prefix
                + (is_propertyless
                       ? ""
                       : prop_name(tfield, !is_propertyless)); // prop name second param by joygram
...
void t_gen_csharp_generator::generate_deserialize_struct(ostream& out,
                                                         t_struct* tstruct,
                                                         string prefix) {
  if (union_ && tstruct->is_union()) {
...
void t_gen_csharp_generator::generate_deserialize_container(ostream& out,
                                                            t_type* ttype,
                                                            string prefix) {
  scope_up(out);
...
void t_gen_csharp_generator::generate_deserialize_map_element(ostream& out,
                                                              t_map* tmap,
                                                              string prefix) {
  string key = tmp("_key");
  string val = tmp("_val");
...
void t_gen_csharp_generator::generate_deserialize_set_element(ostream& out,
                                                              t_set* tset,
                                                              string prefix) {
...
void t_gen_csharp_generator::generate_deserialize_list_element(ostream& out,
                                                               t_list* tlist,
                                                               string prefix) {
  string elem = tmp("_elem");
...
void t_gen_csharp_generator::generate_serialize_field(ostream& out,
                                                      t_field* tfield,
                                                      string prefix,
                                                      bool is_element,
                                                      bool is_propertyless) {
  ...
  string name = prefix
                + (is_propertyless
                       ? ""
                       : prop_name(tfield, !is_propertyless)); // prob_name second param by joygram
  ...
  if (type->is_struct() || type->is_xception()) {
    ...
    string nullable_name
        = nullable_ && !is_element && !field_is_required(tfield) ? name + ".Value" : name;
...
void t_gen_csharp_generator::generate_serialize_struct(ostream& out,
                                                       t_struct* tstruct,
                                                       string prefix) {
  (void)tstruct;
...
void t_gen_csharp_generator::generate_serialize_container(ostream& out,
                                                          t_type* ttype,
                                                          string prefix) {
  scope_up(out);
...
void t_gen_csharp_generator::generate_serialize_map_element(ostream& out,
                                                            t_map* tmap,
                                                            string iter,
                                                            string map) {
...
void t_gen_csharp_generator::generate_serialize_set_element(ostream& out,
                                                            t_set* tset,
                                                            string iter) {
...
void t_gen_csharp_generator::generate_serialize_list_element(ostream& out,
                                                             t_list* tlist,
                                                             string iter) {
...
void t_gen_csharp_generator::generate_property(ostream& out,
                                               t_field* tfield,
                                               bool isPublic,
                                               bool generateIsset) {
  generate_csharp_property(out, tfield, isPublic, generateIsset, "_");
}
void t_gen_csharp_generator::generate_csharp_property(ostream& out,
                                                      t_field* tfield,
                                                      bool isPublic,
                                                      bool generateIsset,
                                                      std::string fieldPrefix) {
...
/// -- start deepclone by joygram 2017/01/15
void t_gen_csharp_generator::generate_deepclone_field(ostream& out,
                                                      t_type* tcontainer,
                                                      t_field* tfield,
                                                      string iter_name,
                                                      string elem_name,
  ...
  string name = (is_propertyless
                     ? ""
                     : prop_name(tfield, !is_propertyless)); // prob_name second param by joygram

  if (type->is_void()) {
    throw "CANNOT GENERATE DEEPCLONE CODE FOR void TYPE: " + name;
  }

  if (type->is_struct() || type->is_xception()) {
    if (is_element) {
      generate_deepclone_struct(out, (t_struct*)type, name, iter_name);
    } else {
      generate_deepclone_struct(out, (t_struct*)type, name, name);
    }
  } else if (type->is_container()) {
    generate_deepclone_container(out, type, is_element, name);
  } else if (type->is_base_type() || type->is_enum()) {
    indent(out);
    // if (tcontainer->is_map() && is_element) {

    if (tcontainer->is_list()) {
    } else {
      out << "target.";
    }
    ...
    string target_name = nullable_name;

    if (type->is_base_type()) {
      t_base_type::t_base tbase = ((t_base_type*)type)->get_base();
      switch (tbase) {
      case t_base_type::TYPE_VOID:
        throw "compiler error: cannot deepclone void field in a struct: " + name;
        break;
      case t_base_type::TYPE_STRING:
        if (is_element) {
        ...
        // if (is_element) {
        //	out << nullable_name << " = " << "String.Copy(" << iter_name << ");";
        //}
        // else {
        //	out << nullable_name << " = " << "String.Copy(" << nullable_name << ");";
        //}
        if (is_element) {
          out << nullable_name << " = $\"{" << iter_name << "}\";";
        } else {
          out << nullable_name << " = $\"{" << nullable_name << "}\";";
        }
      ...
      case t_base_type::TYPE_DOUBLE:
        if (is_element) {
          out << nullable_name << " = " << iter_name << ";" << endl;
        } else {
          out << nullable_name << " = " << nullable_name << ";" << endl;
        }
        break;
      default:
        throw "compiler error: no C# name for base type " + t_base_type::t_base_name(tbase);
...
void t_gen_csharp_generator::generate_deepclone_struct(ostream& out,
                                                       t_struct* tstruct,
                                                       string tgt_name,
                                                       string src_name) {

  string target_prefix = tgt_name;
  if (tgt_name.empty()) {
    target_prefix = "target." + src_name;
  }
  ...
  out << indent() << target_prefix << " =  (" << true_type << ")" << src_name
      << ".DeepClone(); // generate_deepclone_struct" << endl;
}

void t_gen_csharp_generator::generate_deepclone_container(ostream& out,
                                                          t_type* ttype,
                                                          bool is_element,
                                                          string prefix) {
  if (ttype->is_map()) {
    generate_deepclone_map(out, ttype, is_element, prefix);
  } else if (ttype->is_set()) {
    generate_deepclone_set(out, ttype, is_element, prefix);
  } else if (ttype->is_list()) {
    generate_deepclone_list(out, ttype, is_element, prefix);
  }
}

void t_gen_csharp_generator::generate_deepclone_map(ostream& out,
                                                    t_type* ttype,
                                                    bool is_element,
                                                    string prefix) {

  indent(out) << "target." << prefix << " = new " << type_name(ttype, false, true)
              << "(); // generate_deepclone_map" << endl;

  string iter;
  iter = tmp("_map_iter_");
  indent(out) << "foreach (" << type_name(((t_map*)ttype)->get_key_type()) << " " << iter << " in "
              << prefix << ".Keys)" << endl;

  scope_up(out);
  generate_deepclone_map_element(out, (t_map*)ttype, is_element, iter, prefix);
  scope_down(out);
}
void t_gen_csharp_generator::generate_deepclone_set(ostream& out,
                                                    t_type* ttype,
                                                    bool is_element,
                                                    string prefix) {

  indent(out) << "target." << prefix << " = new " << type_name(ttype, false, true)
              << "(); // generate_deepclone_set" << endl;

  string iter;
  iter = tmp("_set_iter_");
  indent(out) << "foreach (" << type_name(((t_set*)ttype)->get_elem_type()) << " " << iter << " in "
              << prefix << ")" << endl;

  scope_up(out);
  generate_deepclone_set_element(out, (t_set*)ttype, is_element, iter, prefix);
  scope_down(out);
}
void t_gen_csharp_generator::generate_deepclone_list(ostream& out,
                                                     t_type* ttype,
                                                     bool is_element,
                                                     string prefix) {
  ...
  // generate_deepclone_list element" << endl;
  //}
  // else
  //{
  indent(out) << "target." << prefix << " = new " << type_name(ttype, false, true)
              << "(); // generate_deepclone_list" << endl;
  //}
  ...
  scope_up(out);
  generate_deepclone_list_element(out, (t_list*)ttype, is_element, iter, prefix);
  scope_down(out);
}

void t_gen_csharp_generator::generate_deepclone_map_element(ostream& out,
                                                            t_map* tmap,
                                                            bool is_container_element,
                                                            string iter_name,
                                                            string map_name) {

  string map_elem_name = map_name + "[" + iter_name + "]";
  t_field vfield(tmap->get_val_type(), map_elem_name);
  generate_deepclone_field(out, tmap, &vfield, map_elem_name, "", true);
}

void t_gen_csharp_generator::generate_deepclone_set_element(ostream& out,
                                                            t_set* tset,
                                                            bool is_container_element,
                                                            string iter_name,
                                                            string set_name) {

  string elem_name = tmp("_set_elem_");
  t_field felem(tset->get_elem_type(), elem_name);
  indent(out) << declare_field(&felem) << "// declare target elem" << endl;

  generate_deepclone_field(out, tset, &felem, iter_name, elem_name, true);

  indent(out) << "target." << set_name << ".Add(" << elem_name << ");" << endl;
}

void t_gen_csharp_generator::generate_deepclone_list_element(ostream& out,
                                                             t_list* tlist,
                                                             bool is_container_element,
                                                             string iter_name,
                                                             string list_name) {

  string elem_name = tmp("_lst_elem_");
  t_field felem(tlist->get_elem_type(), elem_name);
  indent(out) << declare_field(&felem) << "// declare lst target elem" << endl;

  generate_deepclone_field(out, tlist, &felem, iter_name, elem_name, true);

  string target = "target.";
  // if (is_container_element) // list의 경우 container's container인 경우 target.을 붙이지 않는다.
  // 2018/03/20 by joygram
  //{
  //	target = "";
  //}
  indent(out) << target << list_name << ".Add(" << elem_name << ");" << endl;
}

/// --- end of deep clone by joygram 2017/01/15


///////////////////////////////////////////////
/// -- start tostring by joygram 2022/08/11
void t_gen_csharp_generator::generate_dumpstring_field(ostream& out,
                                                       t_type* tcontainer,
                                                       t_field* tfield,
                                                       string iter_name,
                                                       string elem_name,
  ...
  if (type->is_void()) {
    throw "CANNOT generate DumpString() CODE for void type: " + name;
  }

  if (type->is_struct() || type->is_xception()) {
    if (is_element) {
      generate_dumpstring_struct(out, (t_struct*)type, name, iter_name);
    } else {
      generate_dumpstring_struct(out, (t_struct*)type, name, name);
    }
  } else if (type->is_container()) {
    generate_dumpstring_container(out, type, is_element, name);
  } else if (type->is_base_type() || type->is_enum()) {

    indent(out);
    out << "__sb.Append(\"\\t\");" << endl; // indent
    ...
    if (type->is_base_type()) {
      ...
      case t_base_type::TYPE_DOUBLE:
        if (is_element) {
          out << "__sb.Append(\"[\");" << endl;
          out << "__sb.Append(" << iter_name << "); //is_element?" << endl;
        } else {
          out << "__sb.Append(\"" << nullable_name << ":[\");" << endl;
          out << "__sb.Append(" << nullable_name << ");" << endl;
        }
        out << "__sb.Append(\"]\\n\");" << endl;
        break;
      ...
      if (is_element) {
        out << "__sb.Append(\"[\");" << endl;
        out << "__sb.Append(" << iter_name << ");" << endl;
      } else {
        out << "__sb.Append(\"" << nullable_name << ":[\");" << endl;
        out << "__sb.Append(" << nullable_name << ");" << endl;
      }
    ...
    printf("cant create DumpString() '%s%s' TYPE '%s'\n", iter_name.c_str(),
           tfield->get_name().c_str(), type_name(type).c_str());
  }
}

void t_gen_csharp_generator::generate_dumpstring_struct(ostream& out,
                                                        t_struct* tstruct,
                                                        string tgt_name,
                                                        string src_name) {
  string true_type = type_name(tstruct->get_true_type(), false, true);

  indent(out) << "__sb.Append(\"Struct: " << true_type << "\\n\");" << endl;
  indent(out) << "__sb.Append(" << src_name << ".DumpString()); // generate_dumpstring_struct" << endl;
  indent(out) << "__sb.Append(\"\\n\\n\");" << endl;
}

void t_gen_csharp_generator::generate_dumpstring_container(ostream& out,
                                                           t_type* ttype,
                                                           bool is_element,
                                                           string prefix) {
  if (ttype->is_map()) {
    generate_dumpstring_map(out, ttype, is_element, prefix);
  } else if (ttype->is_set()) {
    generate_dumpstring_set(out, ttype, is_element, prefix);
  } else if (ttype->is_list()) {
    generate_dumpstring_list(out, ttype, is_element, prefix);
  }
  out << "__sb.Append(\"\\n\\n\");" << endl;
}

void t_gen_csharp_generator::generate_dumpstring_map(ostream& out,
                                                     t_type* ttype,
                                                     bool is_element,
                                                     string prefix) {

  indent(out) << "__sb.Append(\"== Map " << prefix << "\\n\");" << endl;
  string iter;
  iter = tmp("_map_iter_");
  indent(out) << "foreach (" << type_name(((t_map*)ttype)->get_key_type()) << " " << iter << " in "
              << prefix << ".Keys)" << endl;
  ...
  scope_up(out);
  generate_dumpstring_map_element(out, (t_map*)ttype, is_element, iter, prefix);
  scope_down(out);
}
void t_gen_csharp_generator::generate_dumpstring_set(ostream& out,
                                                     t_type* ttype,
                                                     bool is_element,
                                                     string prefix) {

  indent(out) << "__sb.Append(\"== Set " << prefix << "\\n\");" << endl;
  string iter;
  iter = tmp("_set_iter_");
  indent(out) << "foreach (" << type_name(((t_set*)ttype)->get_elem_type()) << " " << iter << " in "
              << prefix << ")" << endl;
  ...
  scope_up(out);
  generate_dumpstring_set_element(out, (t_set*)ttype, is_element, iter, prefix);
  scope_down(out);
}
void t_gen_csharp_generator::generate_dumpstring_list(ostream& out,
                                                      t_type* ttype,
                                                      bool is_element,
                                                      string prefix) {

  indent(out) << "__sb.Append(\"== List " << prefix << "\\n\");" << endl;
  string iter;
  iter = tmp("_lst_iter_");
  indent(out) << "foreach (" << type_name(((t_list*)ttype)->get_elem_type()) << " " << iter
              << " in " << prefix << ")" << endl;
  ...
  scope_up(out);
  generate_dumpstring_list_element(out, (t_list*)ttype, is_element, iter, prefix);
  scope_down(out);
}

void t_gen_csharp_generator::generate_dumpstring_map_element(ostream& out,
                                                             t_map* tmap,
                                                             bool is_container_element,
                                                             string iter_name,
                                                             string map_name) {
  ...
  string map_elem_name = map_name + "[" + iter_name + "]";
  t_field vfield(tmap->get_val_type(), map_elem_name);
  generate_dumpstring_field(out, tmap, &vfield, map_elem_name, "", true);
}

void t_gen_csharp_generator::generate_dumpstring_set_element(ostream& out,
                                                             t_set* tset,
                                                             bool is_container_element,
                                                             string iter_name,
                                                             string set_name) {
  ...
  generate_dumpstring_field(out, tset, &felem, iter_name, elem_name, true);
}

void t_gen_csharp_generator::generate_dumpstring_list_element(ostream& out,
                                                              t_list* tlist,
                                                              bool is_container_element,
                                                              string iter_name,
                                                              string list_name) {
  ...
  generate_dumpstring_field(out, tlist, &felem, iter_name, elem_name, true);
}
/// --- end of tostring by joygram 2022/08/11
//////////////////////////////////////////////


///////////////////////////////////////////////
/// -- start tojson by joygram 2022/09/05
void t_gen_csharp_generator::generate_tojson_field(ostream& out,
                                                       t_type* tcontainer,
                                                       t_field* tfield,
                                                       string iter_name,
                                                       string elem_name,
  ...
  if (type->is_void()) {
    throw "CANNOT generate tojson() CODE for void type: " + name;
  }

  if (type->is_struct() || type->is_xception()) {
    if (is_element) {
      generate_tojson_struct(out, (t_struct*)type, name, iter_name);
    } else {
      generate_tojson_struct(out, (t_struct*)type, name, name);
    }
  } else if (type->is_container()) {
    generate_tojson_container(out, type, is_element, name);
  } else if (type->is_base_type() || type->is_enum()) {
    ...
    if (type->is_base_type()) {
      ...
      case t_base_type::TYPE_STRING:
        if (is_element) {
          out << std::format("__sb += {}; //is_element:string", iter_name) << endl;
        } else {
          out << std::format("__sb += $\" \\\"{}\\\": \\\"{{{}}}\\\" \";", nullable_name, nullable_name) << endl;
        }
        break;
      case t_base_type::TYPE_BOOL:
      case t_base_type::TYPE_I8:
      ...
      case t_base_type::TYPE_DOUBLE:
        if (is_element) {
          out << std::format("__sb += {}; //is_element ??", iter_name) << endl;
        } else {
          out << std::format("__sb += $\" \\\"{}\\\": {{{}}}\";", nullable_name, nullable_name);
        }
        break;
      ...
      if (is_element) {
        out << std::format("__sb += {}; //is_element enum ?", iter_name);
      } else {
        out << std::format("__sb += $\" \\\"{}\\\": \\\"{{{}}}:{{(Int32){}}}\\\" \";",nullable_name, nullable_name, nullable_name);
      }
    }

    out << endl;
  } else {
    printf("cant create tojson() '%s%s' TYPE '%s'\n", iter_name.c_str(),
           tfield->get_name().c_str(), type_name(type).c_str());
  }
}

void t_gen_csharp_generator::generate_tojson_struct(ostream& out,
                                                        t_struct* tstruct,
                                                        string tgt_name,
                                                        string src_name) {
  string true_type = type_name(tstruct->get_true_type(), false, true);

  indent(out) << std::format("__sb += {}.ToJson(); // generate_tojson_struct", src_name) << endl;
}

void t_gen_csharp_generator::generate_tojson_container(ostream& out,
                                                           t_type* ttype,
                                                           bool is_element,
                                                           string prefix) {
  if (ttype->is_map()) {
    generate_tojson_map(out, ttype, is_element, prefix);
  } else if (ttype->is_set()) {
    generate_tojson_set(out, ttype, is_element, prefix);
  } else if (ttype->is_list()) {
    generate_tojson_list(out, ttype, is_element, prefix);
  }
}

void t_gen_csharp_generator::generate_tojson_map(ostream& out,
                                                     t_type* ttype,
                                                     bool is_element,
                                                     string prefix) {

  indent(out) << std::format("__sb += \"map_{}: {{\"; ", prefix) << endl;
  string iter;
  iter = tmp("_map_iter_");
  indent(out) << "foreach (" << type_name(((t_map*)ttype)->get_key_type()) << " " << iter << " in "
              << prefix << ".Keys)" << endl;
  ...
  scope_up(out);
  generate_tojson_map_element(out, (t_map*)ttype, is_element, iter, prefix);
  //indent(out) << std::format("__sb += \"}}\"; ") << endl;

  scope_down(out);

}
void t_gen_csharp_generator::generate_tojson_set(ostream& out,
                                                     t_type* ttype,
                                                     bool is_element,
                                                     string prefix) {

  indent(out) << std::format("__sb += \"set_{}: {{\"; ", prefix) << endl;
  ...
  scope_up(out);
  generate_tojson_set_element(out, (t_set*)ttype, is_element, iter, prefix);
  //indent(out) << std::format("__sb += \"}}\"; ") << endl;

  scope_down(out);
}
void t_gen_csharp_generator::generate_tojson_list(ostream& out,
                                                      t_type* ttype,
                                                      bool is_element,
                                                      string prefix) {

  indent(out) << std::format("__sb += \"list_{}: [\"; ", prefix) << endl;
  string iter;
  iter = tmp("_lst_iter_");
  indent(out) << "foreach (" << type_name(((t_list*)ttype)->get_elem_type()) << " " << iter
              << " in " << prefix << ")" << endl;
  ...
  scope_up(out);
  generate_tojson_list_element(out, (t_list*)ttype, is_element, iter, prefix);
  //indent(out) << std::format("__sb += \"]\"; ") << endl;

  scope_down(out);
}

void t_gen_csharp_generator::generate_tojson_map_element(ostream& out,
                                                             t_map* tmap,
                                                             bool is_container_element,
                                                             string iter_name,
                                                             string map_name) {
  ...
  string map_elem_name = map_name + "[" + iter_name + "]";
  t_field vfield(tmap->get_val_type(), map_elem_name);
  generate_tojson_field(out, tmap, &vfield, map_elem_name, "", true);
}

void t_gen_csharp_generator::generate_tojson_set_element(ostream& out,
                                                             t_set* tset,
                                                             bool is_container_element,
                                                             string iter_name,
                                                             string set_name) {
  ...
  generate_tojson_field(out, tset, &felem, iter_name, elem_name, true);
}

void t_gen_csharp_generator::generate_tojson_list_element(ostream& out,
                                                              t_list* tlist,
                                                              bool is_container_element,
                                                              string iter_name,
                                                              string list_name) {
  ...
  generate_tojson_field(out, tlist, &felem, iter_name, elem_name, true);
}
/// --- end of tojson by joygram 2022/09/05
//////////////////////////////////////////////

std::string t_gen_csharp_generator::make_valid_csharp_identifier(std::string const& fromName) {
...
void t_gen_csharp_generator::cleanup_member_name_mapping(void* scope) {
...
string t_gen_csharp_generator::get_mapped_member_name(string name) {
  if (!member_mapping_scopes.empty()) {
    member_mapping_scope& active = member_mapping_scopes.back();
...
void t_gen_csharp_generator::prepare_member_name_mapping(t_struct* tstruct) {
  prepare_member_name_mapping(tstruct, tstruct->get_members(), tstruct->get_name());
}

void t_gen_csharp_generator::prepare_member_name_mapping(void* scope,
                                                         const vector<t_field*>& members,
                                                         const string& structname) {
  // begin new scope
...
std::string t_gen_csharp_generator::prop_name(t_field* tfield, bool suppress_mapping) {
  string name(tfield->get_name());
  if (suppress_mapping) {
    name[0] = toupper(name[0]); // 제거했을때 예약어 충돌이 많이 발생하여 처음 대문자 제거는
                                // 수행하지 않음 2019/07/02 에 이슈 다시 확인
  } else {
...
string t_gen_csharp_generator::type_name(t_type* ttype,
                                         bool in_container,
                                         bool in_init,
                                         bool in_param,
                                         bool is_required) {
...
string t_gen_csharp_generator::base_type_name(t_base_type* tbase,
                                              bool in_container,
                                              bool in_param,
                                              bool is_required) {
  (void)in_container;
...
string t_gen_csharp_generator::declare_field(t_field* tfield, bool init, std::string prefix) {
...
string t_gen_csharp_generator::function_signature(t_function* tfunction, string prefix) {
  t_type* ttype = tfunction->get_returntype();
  return type_name(ttype) + " " + normalize_name(prefix + tfunction->get_name()) + "("
         + argument_list(tfunction->get_arglist()) + ")";
}

string t_gen_csharp_generator::function_signature_async_begin(t_function* tfunction,
                                                              string prefix) {
...
string t_gen_csharp_generator::function_signature_async_end(t_function* tfunction, string prefix) {
  t_type* ttype = tfunction->get_returntype();
  return type_name(ttype) + " " + normalize_name(prefix + tfunction->get_name())
         + "(IAsyncResult asyncResult)";
}

string t_gen_csharp_generator::function_signature_async(t_function* tfunction, string prefix) {
  t_type* ttype = tfunction->get_returntype();
  string task = "Task";
  if (!ttype->is_void())
...
string t_gen_csharp_generator::argument_list(t_struct* tstruct) {
  string result = "";
  const vector<t_field*>& fields = tstruct->get_members();
  vector<t_field*>::const_iterator f_iter;
  bool first = true;
...
string t_gen_csharp_generator::type_to_enum(t_type* type) {
  while (type->is_typedef()) {
    type = ((t_typedef*)type)->get_type();
  }
...
void t_gen_csharp_generator::generate_csharp_docstring_comment(ostream& out, string contents) {
  generate_docstring_comment(out, "/// <summary>\n", "/// ", contents, "/// </summary>\n");
}

void t_gen_csharp_generator::generate_csharp_doc(ostream& out, t_field* field) {
...
void t_gen_csharp_generator::generate_csharp_doc(ostream& out, t_doc* tdoc) {
  if (tdoc->has_doc()) {
    generate_csharp_docstring_comment(out, tdoc->get_doc());
  }
}

void t_gen_csharp_generator::generate_csharp_doc(ostream& out, t_function* tfunction) {
...
std::string t_gen_csharp_generator::get_enum_class_name(t_type* type) {
  string package = "";
...
THRIFT_REGISTER_GENERATOR(
    gen_csharp,
    "GEN C# for GameEngine one merged file by namespace",
