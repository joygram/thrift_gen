...
std::ofstream f_file_; // by joygram for single file
...
//  namespace_dir_ = subdir;
  ...
  string f_file_name = get_out_dir() + program_name_ + ".cs";
  f_file_.open(f_file_name.c_str());
...
//  start_csharp_namespace(f_consts);
  ofstream& f_consts = f_file_; //  [2015/7/6/ joygram]
  ...
  //f_consts.close(); //  [2015/7/6/ joygram]
}
...
//  f_struct << autogen_comment() << csharp_type_usings() << csharp_thrift_usings() << endl;
  ...
  ofstream& f_struct = f_file_; //  [2015/7/6/ joygram]
...
void t_csharp_generator::generate_csharp_union(t_struct* tunion) {
  ...
  ofstream& f_union = f_file_; //  [2015/7/6/ joygram]
...
void t_csharp_generator::generate_service(t_service* tservice) {
  ...
  ofstream& f_service_ = f_file_; //  [2015/7/6/ joygram]
