...
//f_consts_impl << "const " << program_name_ << "Constants g_" << program_name_ << "_constants;"
  f_consts_impl << "const " << program_name_ << "Constants constants;" 
 ...
 // by joygram
 //f_consts << endl << "extern const " << program_name_ << "Constants g_" << program_name_ << "_constants;" << endl << endl
  f_consts << endl << "extern const " << program_name_ << "Constants constants;" << endl << endl
           << ns_close_ << endl << endl << "#endif" << endl;
  f_consts.close();
